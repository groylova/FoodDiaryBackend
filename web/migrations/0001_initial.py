# Generated by Django 4.1.6 on 2023-02-22 23:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protein_amount', models.PositiveIntegerField(null=True, verbose_name='Protein amount')),
                ('protein_percent', models.PositiveIntegerField(null=True, verbose_name='Protein percent')),
                ('fat_amount', models.PositiveIntegerField(null=True, verbose_name='Fat amount')),
                ('fat_percent', models.PositiveIntegerField(null=True, verbose_name='Fat percent')),
                ('carb_amount', models.PositiveIntegerField(null=True, verbose_name='Carb amount')),
                ('carb_percent', models.PositiveIntegerField(null=True, verbose_name='Carb percent')),
                ('calories_amount', models.PositiveIntegerField(null=True, verbose_name='Amount of calories')),
                ('calories_percent', models.PositiveIntegerField(null=True, verbose_name='Calories percent of portion')),
                ('default', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal_type', models.IntegerField(choices=[(0, 'Lose Weight'), (1, 'Gain Weight'), (2, 'Dont Overeat'), (3, 'Eat Fewer Ing'), (4, 'Eat Fewer Ing Type'), (5, 'Eat More Ing'), (6, 'Eat More Ing Type'), (7, 'Pfc Balance'), (8, 'Find Trigger')], verbose_name='Goal type')),
                ('description', models.CharField(max_length=1000, verbose_name='Description')),
                ('calc_type', models.IntegerField(choices=[(0, 'Whole'), (1, 'Period')], verbose_name='Calculation type')),
                ('period', models.IntegerField(choices=[(0, 'Day'), (1, 'Week'), (2, 'Month'), (3, 'Year'), (4, 'Custom')], verbose_name='Period type')),
                ...
                ('scale', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='web.scale')),
            ],
        ),
        migrations.CreateModel(
            name='Feeling',
            fields=[
                ...
                ('scale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feelings', to='web.scale')),
            ],
        ),
        migrations.CreateModel(
            name='CustomScale',
